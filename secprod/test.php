...
<br />
 ...
 <?php 
    ...
    $products = new Item('6066069', 'ALSHIFA HONEY 170g', '3333');
    
    foreach ($products as $row) {
        print_r($product . ': ' . $sku . '<br>');
    }
    ...
    $data = array(
        "000033333" => array("000033333", "40958987", "303888", "56060506", "3333"),
        "000033334" => array("000033334", "40958988", "303889", "56060507", "4444"),
        "000033335" => array("000033335", "40958989", "303890", "56060508", "5555")
    );
    print_r($data);
    if(is_array($data)){
        foreach ($data as $row) {
