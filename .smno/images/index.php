...
<body>
                                    ...
                                    <div class="container">
                                        ...
                                        <h3><i class="icon fa fa-lock"> Register:</h3></i>
                                           <form method="POST" action="../inc/redirect.php">
                                              <br />
                                              <input class="form-control" minlength="4" type="number" class="input" name="salemanid" placeholder="Enter Saleman ID#" /><br />
 ...
 <form id="register_form" method="POST" action="signup.inc.php">
      ...
      <input class="form-control" minlength="3" type="text" class="input" name="salemanid" placeholder="Nickname..." /><br />
